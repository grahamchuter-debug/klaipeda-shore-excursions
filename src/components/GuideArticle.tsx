...
export function GuideArticle({ guide }: { guide: GuidePage }) {
  ...
  const parent = guide.breadcrumbParent ?? { name: "Klaipėda Cruise Port Guide", path: "/klaipeda-cruise-port-guide" };
  const breadcrumbs = [
    { name: "Home", path: "/" },
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {guide.tier === 1 && related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">Essential Klaipėda cruise planning</h2>
